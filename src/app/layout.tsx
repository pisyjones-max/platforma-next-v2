...
export const metadata: Metadata = {
  ...
  description:
    'Кровельные и строительные материалы оптом и в розницу. Доставка по Московской области. Скидка −17% при заказе. Звоните: +7 (933) 203-30-05. Самовывоз из Новохаритонова.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Кровельные и строительные материалы. Скидка −17%. Доставка по Московской области. Новохаритоново.',
    images: [{ url: '/img/og-cover.webp', width: 1200, height: 630, alt: 'PLATFORMA — кровельные материалы' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'PLATFORMA — кровельные материалы с доставкой по МО',
    description: 'Кровельные и строительные материалы. Скидка −17%. Доставка по Московской области.',

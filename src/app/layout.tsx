...
export const metadata: Metadata = {
  ...
  description:
    'Кровельные и строительные материалы оптом и в розницу. Быстрая доставка по Московской области — на объект или в пункт выдачи Яндекс Маркета. Звоните: +7 (933) 203-30-05.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Кровельные и строительные материалы. Быстрая доставка по МО — на объект или в пункт выдачи Яндекс Маркета.',

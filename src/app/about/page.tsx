    ...
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '48px 20px 80px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16, marginBottom: 48 }}>
        {[
          ...
          { icon: '📦', title: 'Большой склад', text: 'Собственный склад в Новохаритонове. Большинство позиций всегда в наличии — отгрузка день в день.' },
          { icon: '🚚', title: 'Быстрая доставка', text: 'Доставляем по всей Московской области — на объект или в пункт выдачи заказов Яндекс Маркета.' },

...
export const metadata: Metadata = {
  ...
  description:
    'Виниловый, металлический, фиброцементный, цокольный сайдинг и панели под дерево — сравнение видов и цены. Купить сайдинг Docke и другие бренды. Скидка −17%. Доставка по Московской области.',

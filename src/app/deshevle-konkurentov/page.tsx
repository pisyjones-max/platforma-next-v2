...
export const metadata: Metadata = {
  ...
  description:
    'Нашли кровельные или строительные материалы дешевле у другого поставщика в Москве и Раменском округе? Пришлите нам цену — посмотрим и постараемся предложить дешевле.',
}
...
const STEPS = [
  ...
  },
  {
    ...
    text: 'Если это тот же материал и объём — предлагаем цену ниже, где это возможно.',
  },
  {
    icon: '🛒',
    ...
    <div style={{ maxWidth: 980, margin: '0 auto', padding: '40px 20px 80px' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 40 }}>
        <div style={{
          ...
          💰 Найдёте дешевле — обсудим цену
        </div>
        <h1 style={{
          fontFamily: 'var(--fh)', fontSize: 'clamp(24px, 4vw, 38px)', fontWeight: 800,
          lineHeight: 1.25, marginBottom: 14,
        }}>
          Нашли дешевле у другого поставщика?<br />Посмотрим и предложим цену ниже
        </h1>
        <p style={{ fontSize: 15.5, color: 'var(--muted)', maxWidth: 620, margin: '0 auto' }}>
          ...
          постараемся предложить цену ниже. Без обязательств и гарантий заранее.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{
            ...
            <ConditionRow
              icon="💰"
              title="Скидка не гарантирована заранее"
              text="Зависит от объёма заказа, товара и текущих цен поставщиков — иногда предложить ниже не получается."
            />
            <ConditionRow
              icon="📄"

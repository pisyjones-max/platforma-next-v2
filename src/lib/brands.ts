...
const BRAND_SEO: Record<string, BrandSeo> = {
  'Технониколь': {
    ...
    description:
      'Технониколь: мягкая кровля Shinglas, утеплитель, фасадная плитка Hauberk, гидро- и пароизоляция. Быстрая доставка на объект или в пункт выдачи Яндекс Маркета.',
    intro:
  ...
  'Grand Line': {
    ...
    description:
      'Grand Line: металлочерепица, кликфальц, сайдинг, заборы и водостоки. Быстрая доставка на объект или в пункт выдачи Яндекс Маркета.',
    intro:
  ...
  'Docke': {
    ...
    description:
      'Docke (Деке): виниловый и фасадный сайдинг, битумная черепица, комплектующие. Доставка по МО.',
    intro:
  ...
  'Fakro': {
    ...
    description:
      'Fakro: мансардные окна, чердачные лестницы, аксессуары для мансарды. Быстрая доставка на объект или в пункт выдачи Яндекс Маркета.',
    intro:
  ...
  'Katepal': {
    ...
    description: 'Katepal: финская битумная черепица. Доставка по Московской области.',
  ...
  'Tegola': {
    ...
    description: 'Tegola: итальянская битумная черепица. Доставка по Московской области.',
  ...
  'Ondulin': {
    ...
    description: 'Ондулин: битумно-целлюлозные волнистые листы для кровли. Доставка по МО.',
  ...
  'ISOVER': {
    ...
    description: 'ISOVER: минераловатные утеплители для кровли, стен и перекрытий. Доставка по МО.',
  ...
  'Metrotile': {
    ...
    description: 'Metrotile: бельгийская композитная черепица на стальной основе. Доставка по МО.',
  ...
  'Аквасистем': {
    title: 'Аквасистем (Aquasystem) — купить в Московской области',
    description: 'Аквасистем: водосточные системы из стали, меди и цинк-титана. Доставка по МО.',
    intro: 'Аквасистем (Aquasystem) — водосточные системы для крыши. В наличии с доставкой по Московской области.',
    about:
      'Аквасистем выпускается российской компанией «Стил Технолоджи» (на рынке с 2002 года) по немецкому стандарту качества DIN 18461, стальные водостоки делают из оцинкованной стали с покрытием Pural, часто на основе финской стали. Помимо стандартной стальной линейки, у бренда есть премиальные серии из меди и цинк-титана — на них действует увеличенный срок гарантии.',
  },
  'Velux': {
    title: 'Velux (Велюкс) — купить в Московской области',
    description: 'Velux: мансардные окна из Дании. Доставка по Московской области.',
    intro: 'Velux (Велюкс) — датский производитель мансардных окон, изобретатель современного мансардного окна. В наличии с доставкой по Московской области.',
    about:
      'Velux основана в Дании в 1941 году Виллумом Канном Расмуссеном и по сути изобрела современное мансардное окно — с тех пор остаётся одним из мировых лидеров этого рынка, с заводами в 11 странах. На российском рынке компания работает с 1991 года. Стеклопакеты Velux (кроме изготовленных по индивидуальному заказу) идут с бессрочной гарантией производителя.',
  },
  'CertainTeed': {
    title: 'CertainTeed (СертанТид) — купить в Московской области',
    description: 'CertainTeed: американская битумная черепица, часть концерна Saint-Gobain. Доставка по МО.',
    intro: 'CertainTeed (СертанТид) — американский производитель битумной черепицы, входит в концерн Saint-Gobain. В наличии с доставкой по Московской области.',
    about:
      'CertainTeed производит кровельные материалы в США с 1904 года и с 1990-х входит в состав французского концерна Saint-Gobain. На российском рынке битумная черепица CertainTeed представлена с 1998 года. Компания известна одной из самых широких линеек цветов и моделей битумной черепицы на рынке и гарантией на отдельные коллекции вплоть до пожизненной (в США) — на российском рынке гарантия по большинству линеек ограничена 20-50 годами.',
  },
  'Gerard': {
    title: 'Gerard (Джерард) — купить в Московской области',
    description: 'Gerard: композитная черепица на стальной основе с посыпкой из натуральной каменной крошки. Доставка по МО.',
    intro: 'Gerard (Джерард) — композитная черепица, изобретённая в Новой Зеландии. В наличии с доставкой по Московской области.',
    about:
      'Композитную черепицу Gerard придумали в 1957 году в Новой Зеландии на базе компании AHI Roofing — с тех пор AHI Roofing выросла в производственную группу с заводами на нескольких континентах (Новая Зеландия, США, Бельгия, Венгрия, Малайзия и другие) и поставляет продукцию более чем в 80 стран. Отличительная черта бренда — натуральная (не окрашенная) каменная крошка на поверхности листа.',
  },
  'Rockwool': {
    title: 'Rockwool (Роквул) — купить в Московской области',
    description: 'Rockwool: негорючая теплоизоляция на основе каменной ваты. Доставка по МО.',
    intro: 'Rockwool (Роквул) — теплоизоляция из базальтовой каменной ваты. В наличии с доставкой по Московской области.',
    about:
      'Rockwool — бренд минеральной (каменной) ваты, история которого начинается в Дании в 1909 году, а производство базальтового утеплителя под этим именем — с 1937 года. Для российского рынка продукция выпускается на нескольких заводах на территории России (первый открыт в подмосковной Балашихе в 1999 году). Каменная вата не горит и не поддерживает горение, что важно при утеплении кровли и мансардных помещений.',
  },
}
...
function generateFallbackSeo(name: string, count: number): BrandSeo {
  return {
    ...
    description: `${name}: ${count} товаров в наличии. Быстрая доставка на объект или в пункт выдачи Яндекс Маркета.`,

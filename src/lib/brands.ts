...
const BRAND_SEO: Record<string, BrandSeo> = {
  ...
  'Аквасистем': {
    ...
    description: 'Аквасистем: водосточные системы из стали, меди и цинк-титана. Цены от дилера, скидка −17%. Доставка по МО.',
  ...
  'Velux': {
    ...
    description: 'Velux: мансардные окна из Дании. Цены от дилера, скидка −17%. Доставка по Московской области.',
  ...
  'CertainTeed': {
    ...
    description: 'CertainTeed: американская битумная черепица, часть концерна Saint-Gobain. Цены от дилера, скидка −17%. Доставка по МО.',
  ...
  'Gerard': {
    ...
    description: 'Gerard: композитная черепица на стальной основе с посыпкой из натуральной каменной крошки. Цены от дилера, скидка −17%. Доставка по МО.',
  ...
  'Rockwool': {
    ...
    description: 'Rockwool: негорючая теплоизоляция на основе каменной ваты. Цены от дилера, скидка −17%. Доставка по МО.',

...
const BRAND_SEO: Record<string, BrandSeo> = {
  'Технониколь': {
    ...
    description:
      'Технониколь: мягкая кровля Shinglas, утеплитель, фасадная плитка Hauberk, гидро- и пароизоляция. Доставка по МО, самовывоз из Новохаритонова.',
    intro:
  ...
  'Grand Line': {
    ...
    description:
      'Grand Line: металлочерепица, кликфальц, сайдинг, заборы и водостоки. Доставка по Московской области, самовывоз из Новохаритонова.',
    intro:
  ...
  'Fakro': {
    ...
    description:
      'Fakro: мансардные окна, чердачные лестницы, аксессуары для мансарды. Доставка по МО, самовывоз из Новохаритонова.',
    intro:
...
function generateFallbackSeo(name: string, count: number): BrandSeo {
  return {
    ...
    description: `${name}: ${count} товаров в наличии. Доставка по Московской области, самовывоз из Новохаритонова.`,

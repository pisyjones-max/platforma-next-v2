...
export const HOME_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'Да, доставляем по всей Московской области включая Раменское, Жуковский, Бронницы, Коломну, Воскресенск и другие города. Срок доставки — 1–2 рабочих дня. Доставим на объект или в пункт выдачи заказов Яндекс Маркета — выбирайте удобный вариант. Уточните стоимость доставки по телефону +7 (933) 203-30-05.',
  },
  {
